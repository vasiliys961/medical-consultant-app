...
3. Если будет вопрос о техническом аспекте отвечай по только дополнительному запросу.
   Если технический — выполни шаги по формату «Техническая консультация» (см. ниже).
